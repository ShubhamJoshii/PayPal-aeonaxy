  ...
  return (
    <>
      <div className="my-16  m-auto text-center">
        <h1 className="text-primary-Color  text-2xl sm:text-3xl  lg:text-5xl font-extrabold">
          Make the most of your <br /> money
        </h1>
        <p className="text-third-Color  text-base sm:text-xl  lg:text-2xl font-extrabold mt-4">
