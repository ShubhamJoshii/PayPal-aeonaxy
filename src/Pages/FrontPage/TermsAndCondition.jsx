...
const TermsAndCondition = () => {
  return (
    <div className="w-[70vw] text-justify m-auto flex flex-col gap-4 text-[#0e1e56] font-semibold text-[13px] my-16">
      <p>
